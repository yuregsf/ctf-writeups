...
c = [-67, 35, 40, 110, -44, -95, -78, 107, -32, 45, -61, -82, -83, -18, 121, -110, -52, -114, -87, -95, -54, 125, -34, -41]
...
a = [-67, 35, 40, 110, -44, -95, -78, 107, -32, 45, -61, -82, -83, -18, 121, -110, -52, -114, -87, -95, -54, 125, -34, -41]

for j in range(0,10000):
    s = ''
    r = Random(42)
    for k in range(0, j): build_map(r)
    r.nextBytes(a)
    for i in range(0, len(a)):
        h = a[i] ^ c[i]
        if h not in range(0,256): 
            s = ''
            break
        s += hex(h)

    if s != '': print("AAAAAAAAAA")
